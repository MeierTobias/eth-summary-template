...
% set title margins
\if 1\tightlayout
  \newcommand{\customtitletopmargin}{-1pt}
  \newcommand{\customtitlebottommargin}{-1pt}
  \newcommand{\customtitleaftermargin}{-3pt}
\else
  \newcommand{\customtitletopmargin}{0pt}
  \newcommand{\customtitlebottommargin}{0pt}
  \newcommand{\customtitleaftermargin}{0pt}
\fi
...
\newcommand{\customtitlebackground}[4]{\begin{tcolorbox}[
      ...
      left=0pt,
      right=0pt,
      top=\customtitletopmargin,
      bottom=\customtitlebottommargin,
      nobeforeafter,
...
\titlespacing{\section}{0pt}{1pt}{\customtitleaftermargin}
...
\titlespacing{\subsection}{0pt}{1pt}{\customtitleaftermargin}
% set background color as an optional parameter
...
\titlespacing{\subsubsection}{0pt}{1pt}{\customtitleaftermargin}
% set background color as an optional parameter
...
\titlespacing{\paragraph}{0pt}{1pt}{\customtitleaftermargin}
% set background color as an optional parameter
